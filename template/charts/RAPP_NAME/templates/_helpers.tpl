...
Selector labels
*/}}
{{- define "RAPP_NAME.selectorLabels" -}}
app.kubernetes.io/name: {{ include "RAPP_NAME.name" . }}
...
Common labels
*/}}
{{- define "RAPP_NAME.labels" }}
app.kubernetes.io/name: {{ include "RAPP_NAME.name" . }}
helm.sh/chart: {{ include "RAPP_NAME.chart" . }}
{{ include "RAPP_NAME.selectorLabels" . }}
app.kubernetes.io/version: {{ include "RAPP_NAME.version" . }}
app.kubernetes.io/instance: {{ .Release.Name }}
{{- if .Chart.AppVersion }}
...
*/}}
{{- define "RAPP_NAME.pullSecret.global" -}}
{{- $pullSecret := "" -}}
{{- if .Values.global -}}
...
*/}}
{{- define "RAPP_NAME.pullSecret" -}}
{{- $pullSecret := (include "RAPP_NAME.pullSecret.global" . ) -}}
...
*/}}
{{- define "RAPP_NAME.registryImagePullPolicy.global" -}}
...
*/}}
{{- define "RAPP_NAME.registryImagePullPolicy" -}}
    {{- $globalRegistryPullPolicy := (include "RAPP_NAME.registryImagePullPolicy.global" . ) -}}
    {{- if .Values.imageCredentials -}}
...
*/}}
{{- define "RAPP_NAME.appArmorProfile.type" -}}
...
*/}}
{{- define "RAPP_NAME.appArmorProfileAnnotation" }}
...
*/}}
{{- define "RAPP_NAME.seccomp-profile" }}
...
*/}}
{{- define "RAPP_NAME.terminationGracePeriodSeconds" -}}
...
*/}}
{{- define "RAPP_NAME.securityPolicy.reference" -}}
  {{- if .Values.global -}}
...
*/}}
{{- define "RAPP_NAME.securityPolicy.annotations" -}}
